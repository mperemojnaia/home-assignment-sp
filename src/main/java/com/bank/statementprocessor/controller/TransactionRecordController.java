...
import com.bank.statementprocessor.exception.EmptyFileException;
import com.bank.statementprocessor.mapper.ValidationReportMapper;
import com.bank.statementprocessor.service.TransactionRecordValidationService;
...
public class TransactionRecordController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = com.bank.statementprocessor.dto.ProblemDetail.class)
                    )
            ),
            @ApiResponse(
                    responseCode = "413",
