package com.bank.statementprocessor.controller;
...
class TransactionRecordControllerIntegrationTest {
    ...
    void testUploadValidJsonFile() throws Exception {
        ...
        assertThat(report.getFailures())
                .anyMatch(f -> f.getReference().equals(167875L) && 
                             f.getReasons().contains(com.bank.statementprocessor.domain.ValidationFailure.FailureReason.INCORRECT_END_BALANCE))
    ...
    void testUploadFileWithValidationFailures() throws Exception {
        ...
        long balanceFailureCount = report.getFailures().stream()
                ...
                .filter(f -> f.getReasons().contains(
                        com.bank.statementprocessor.domain.ValidationFailure.FailureReason.INCORRECT_END_BALANCE))
                .count();
    ...
    void testUploadWithoutFileParameter() throws Exception {
        ...
        String responseBody = result.getResponse().getContentAsString();
        com.bank.statementprocessor.dto.ProblemDetail problem = 
                objectMapper.readValue(responseBody, com.bank.statementprocessor.dto.ProblemDetail.class);
